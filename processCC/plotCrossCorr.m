% this script was written to plot the correlations
% Hence a part of the script will be same as assembleFinite CC pairs
clear; close all;
...
%    "YDK3A";"YGKGA";"YHKVA"]; % improved low-freq resolution
%%
...
%   "YEOMA";"YUOZA";"X6NQA";"YAOTA";"X7ORA";"Y4NCA"];
...
% now filter the correlations and observe
load('HdBp1_3Hz.mat');

for i = 1:1:length(ccStoreFinal(1,:))
    ccFilt(:,i) = filtfilt(HdBp1_3Hz.Numerator,1,ccStoreFinal(:,i));
end

figure(10)
plotseis(ccFilt,tArray,(rayAttribute(:,5)/1000),2);