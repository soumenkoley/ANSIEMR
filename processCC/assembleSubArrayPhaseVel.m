...
velUse = load([subPath,'subArray01\OvertGrp.txt']);
storeStr = 'subArray01Grp';
fExt = 1.2:0.1:2.5;
...
%     "YLOWA";"YUOZA"];
%stnList = ["YKQHA";"YIQEA";"YJQBA";"YHP8A";"YCQGA";"YAQGA";"YAQEA";...
%    "X5QHA";"X3QDA";"XYPWA";"YAP0A";"YNP9A";"YUP2A"];
...
% did not work well
%stnList = ["XVM7A";"XPM9A";"XHNAA";"XHNLA";"W5NUA";"W7N9A";"XDOGA";...
%    "XAOYA";"XGPDA";"XIPOA";"XPPNA";"XYPWA";"YAP0A";"YFPTA";"YIPMA";...
%    "YOPFA";"YUOZA";"YXOQA";"YSOJA";"YUNZA";"YUNJA";"YLNBA";"X6M2A"];
...
rayAttributeStore = rayAttributeStore(:,(~isnan(ccStoreFinal(1,:))));
phaseVelStore = phaseVelStore(:,(~isnan(ccStoreFinal(1,:))));
timePickStore = timePickStore(:,(~isnan(ccStoreFinal(1,:))));
errorTStore = errorTStore(:,(~isnan(ccStoreFinal(1,:))));
