function [fExt,distOut,timePickUpdated,velPickUpdated,phasePick,spectralSNR,figTT] = ...
    FTANNewUpd(inputCC,lagV,minAlpha,maxAlpha,fSamp,fExt,distIn,plotSet,caseNo,picNo,beta)
